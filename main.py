...
def start_handler(update, context):
  ...
  update.message.reply_text('GỬI VIDEO ĐI CHỨ CÒN GÌ NỮA',parse_mode=_ParseMode)
...
def about_handler(update, context):
    ...
    update.message.reply_text('[🏖 TikTok Download API🏖]',parse_mode=_ParseMode)
...
def Download_Video(Link,update, context):
    ...
    status_msg=message.reply_text('🚀 ĐANG TẢI VIDEO TIKTOK KHÔNG WATERMARK ....')
...
🔰 BẢN QUYỀN: HOÀI NAM ĐZAI

◇───────────────◇"""
    
    # Uploading Downloaded Videos to Telegram
    print('ĐANG TẢI VIDEO')
    status_msg.edit_text('☘️ ĐANG TẢI VIDEO LÊN TELEGRAM....')
